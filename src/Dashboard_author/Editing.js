...
const handleTextInputChange = (event) => {
	...
	const onSubmit = async (data,e) => {
		...
		console.log(data);
		e.preventDefault();
		const response = await fetch("https://random1.onrender.com/editing", {
			method: "POST",
			headers: {
	  ...
	  <Link to="/Editing" style={{textDecoration:'none',color:'#000000',fontSize:'16px',fontWeight:400,width:"52px",height:"27px",marginLeft:'26px',letterSpacing: '0.02em'}}>
		  ...
		  <Link to="/AmazonAds" style={{textDecoration:'none',color:'#333335',fontSize:'16px',fontWeight:400,width: '94px',letterSpacing: '0.02em',height: '27px',marginLeft:'36px'}}>
			...
			<Grid item md={12} sx={{textAlign:'initial'}}>
					<Typography sx={{ml:'84px',marginTop:'56px',fontSize: '18px'}} >What type of editing are you looking for? </Typography>		 
				</Grid>
				<Grid item md={6}  sx={{textAlign:'initial',marginTop:'16px'}}>
		<label htmlFor="field-rain" style={{marginLeft:'82px',fontSize:'18px',lineHeight:"28px",marginTop:'8px'}}>
                    <input
                ...
                <label htmlFor="field-wind" style={{marginLeft:'82px',fontSize:'18px',lineHeight:"28px",marginTop:'8px'}}>
                    <input
                        {...register("EditingType")}
                        type="radio"
                        value="Copyediting"
                ...
                <label htmlFor="field-sun" style={{marginLeft:'82px',fontSize:'18px',lineHeight:"28px",marginTop:'8px'}}>
                    <input
                        {...register("EditingType")}
                        type="radio"
                        value="Proofreading"
			...
			<Grid container md={12}>
				...
				<Button label="Adventurous" variant='outlined'
				  ...
				  <Grid container>
				<Grid item md={12}sx={{textAlign:'initial'}}  >
						  <Typography sx={{ml:'84px',marginTop:'56px',fontSize: '18px'}}>How many words are there in your book?</Typography>
				</Grid>
				...
				<Grid item md={12} sx={{ textAlign: 'initial' }}>
					...
					<Typography sx={{ml:'84px',marginTop:'56px',fontSize: '18px'}}>Additional comments (Optional)</Typography>
				</Grid>
				<Grid item md={6} sx={{marginLeft:"84px",marginTop:"32px"}}>
						  <TextField 
							 required
							 id="Comments"
							 name="Comments"
							 label="Write additional comments here"
						fullWidth

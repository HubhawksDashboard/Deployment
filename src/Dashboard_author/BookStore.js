...
const handleTextInputChange = (event) => {
	...
	const onSubmit = async (data,e) => {
		...
		console.log(data);
		e.preventDefault();
		const response = await fetch("http://localhost:5000/bookstore", {
			method: "POST",
			headers: {
...
height: '45px'}}>
    ...
    <Box component='div'  >
			...
			<Typography sx={{marginTop:'56px',marginLeft:"84px"}}>Which is your preferred book store?</Typography>
				</Grid>
				<Grid item md={6} sx={{
					background: '#FFFFFF', border: '1px solid #F1F1F1',marginLeft:'84px',marginTop:'32px',
borderRadius: '22px'}}>	
					<TextField 
							 required
							 id="Summary"
        ...
        />
			...
			<Grid container md={12}>
			 <Grid item  md={12} sx={{textAlign:'initial'}} >
					<Typography sx={{marginTop:"56px",marginLeft:"84px"}}>Who is the publisher of your book?</Typography>
				</Grid>
				<Grid item md={6} sx={{marginLeft:"84px"}}>
						  <TextField 
							 required
							 id="Summary"
							 name="Summary"
        ...
        />
			...
			<Grid container md={12} >
			 <Grid item>
						  <Typography sx={{marginTop:"68px",marginLeft:"84px"}}>How many stores would you like to get your book placed at?</Typography>
						  </Grid>
						  <Grid item md={6} sx={{marginLeft:"84px"}}><TextField 
							 required
							 id="Summary"
							 name="Summary"
						label="Summary"
        ...
        />
			...
			<Grid container md={12}>
				<Grid item md={12} sx={{textAlign:'initial'}}>
				<Typography sx={{marginTop:"56px",marginLeft:"84px"}}>What kind of promos are you looking for? </Typography>	
				</Grid>
				<Grid item md={6}  sx={{textAlign:'initial',marginLeft:"84px"}}>
			...
			<Grid container md={12} >
				...
				<Grid item md={12} sx={{textAlign:'initial'}}>
					<Typography sx={{marginTop:"56px",marginLeft:"84px"}}>Get a Quote</Typography>
				</Grid>
				<Grid item md={6} sx={{marginLeft:"84px"}}>
						  <TextField 
							 required
        ...
        />
				...
				<Grid item md={12} sx={{textAlign:'initial'}}>
						  <Typography sx={{marginTop:"56px",marginLeft:"84px"}}>Additional comments (Optional)</Typography>
				</Grid>
				<Grid item md={6} sx={{marginLeft:"84px"}} >
					<TextField 
							 required

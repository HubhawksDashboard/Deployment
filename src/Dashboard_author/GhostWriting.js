...
function GhostWriting(props, status, r, profile,dash) {
    ...
    <Box component='form' encType="multipart/form-data"
      method="post"  onSubmit={handleSubmit} >
			...
			<Grid item md={12} sx={{textAlign:'initial'}}>
						<Typography sx={{marginTop:'56px',marginLeft:'84px',fontSize:"18px"}}>What is the author’s background?</Typography>
					</Grid>
		...
		<label htmlFor="field-rain">
				...
				<Button label="Adventurous" variant='outlined'
				  ...
				  <Grid container md={12}>
					  <Grid item md={12}  >
						<Typography sx={{textAlign:'initial',marginLeft:'84px',marginTop:'16px'}}>Get a Quote</Typography>
					</Grid>
				...
				<Grid item md={12}>
						  <Typography sx={{textAlign:'initial',marginLeft:'84px',marginTop:'16px'}}>Additional comments (Optional)</Typography>
					</Grid>
					<Grid item md={6} sx={{textAlign:'initial',marginLeft:'84px',marginTop:'32px'}}>
						<TextField 
							 required
